...
Before answering, call the search tool exactly twice with two different queries
in the same model response so the searches can run together. After both search
results are returned, analyze them and answer without calling search again.
